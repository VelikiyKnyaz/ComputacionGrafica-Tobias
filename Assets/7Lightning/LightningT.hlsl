...
void ComputeAdditionalLightingToon_float(float3 normalWS, float3 positionWS, UnityTexture2D toonRamp, UnitySamplerState sState, float3 viewDirWS, float specularHardness, out float3 diffuse, out float3 specular)
{
    diffuse = 0;
    specular = 0;
    #if !defined(SHADERGRAPH_PREVIEW)
